...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // <-- added: save token if backend returns one
      if (data.token) {
      ...
      // Optional redirect after signup success
      // router.push('/signin');
    } catch (error) {
      ...
      >
        <GlassCard>
          ...
          <Typography
            variant="h5"
            component="h1"
            sx={{ fontWeight: 600, color: "white", mb: 1, textAlign: "center" }}
          >
            Create your account
          </Typography>
          <Typography
